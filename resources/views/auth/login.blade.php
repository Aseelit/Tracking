...
rel="stylesheet"
type="text/css"
href="{{ asset('app-assets/css-rtl/components.min.css') }}"
/>
<link href="{{ asset('css/app.css') }}" rel="stylesheet">
{{-- auth --}}
  
<link rel="stylesheet" type="text/css" href="{{ asset('app-assets/css-rtl/plugins/forms/form-validation.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('app-assets/css-rtl/pages/authentication.cs') }}s"
    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="index.html" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ms-1">Fahd</h2>
        </a>

        <h4 class="card-title mb-1">Welcome to System Employ! 👋</h4>
        ...
        @enderror
          ...
          <div class="mb-1">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="remember-me" name="remember" {{ old('remember') ? 'checked' : '' }}  tabindex="3" />
