          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="input-group input-group-lg mb-1">
                ...
                <input type="text" class="form-control form-control-lg  @error('facebook') is-invalid @enderror" placeholder="facebook" name="facebook">
                @error('facebook')
            ...
            @enderror
              ...
              <div class="input-group input-group-lg mb-1">
                ...
                <input type="text" class="form-control form-control-lg  @error('twitter') is-invalid @enderror" placeholder="twitter" name="twitter">
                @error('twitter')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            @enderror
              ...
              <div class="input-group input-group-lg mb-1">
                ...
                <input type="text" class="form-control form-control-lg  @error('twitter') is-invalid @enderror" placeholder="instagram" name="insta">
                @error('instagram')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            @enderror
              ...
              <div class="input-group input-group-lg mb-1">
                ...
                <input type="text" class="form-control form-control-lg @error('whatsApp') is-invalid @enderror" placeholder="WhatsApp" name="whatsApp">
                @error('whatsApp')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
